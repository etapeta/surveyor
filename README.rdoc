...
All, except existance, can have a special implementation that allows 
...
[feature] a survey can have a further mode, :design, that lets the user change
  the survey structure.

[feature] if a survey can be changed dynamically (see :design mode), it needs 
...
[feature] a survey can be applied a survey sheet.
...
[feature] a survey is often used as an exam or quiz, expecting some results.

  Enhance the survey features to manage quizzes as well.

------

== TO DO LIST
- use "render" name for rendering of html coder (or renderer)
- validation rules on element names
- :length option for string element
- :show mode
- labels internationalization and :i18n (or :label) option handling
- :class option
- tip management and :tip option
- survey error messages and mistaken fields identification
- :regexp option for string fields
- survey sheets
- calendar element
- text area element
- checkbox element
